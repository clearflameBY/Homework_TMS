...
//    private let baseURL = "https://catalog.api.2gis.com/3.0/items?q=ATM&fields=items.point,items.address&key=666718af-29db-461a-967f-9b0cb1cc20e5"
//
...
//            URLQueryItem(name: "q", value: query), // например "банкомат"

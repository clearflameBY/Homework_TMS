...
class SecondCallbackViewControllerForSwitch: UIViewController {

    private var customView = SecondViewForCallbackBySwitch()
    ...
    @objc private func goBackTapped() {
        callback(String(customView.switchElement.isOn))
